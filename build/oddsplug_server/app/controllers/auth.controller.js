...
const register = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const auths = yield authService.getAuthentication({ email });
        if (auths.length > 0) {
        ...
        const auth = yield authService.createAuthentication({ email, password: hashedPassword, role: "user", username, devices: [userAgent] });
        ...
        const updateAuth = yield authService.updateAuthentication({ email }, { JWT: refreshToken });
        if (!updateAuth) {
    ...
    try {
        ...
        try {
            if (yield bcryptjs_1.default.compare(password, auth.password)) {
                ...
                const updateAuth = yield authService.updateAuthentication({ email }, { devices: auth.devices });
                const newUser = Object.assign({}, user);
                newUser.authId = newUser.id;
                delete newUser.id;
                delete newUser.sec;
...
const resetPasswordFunction = (auth, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const authService = new authentication_service_1.default();
        const updateAuth = yield authService.updateAuthentication({ _id: auth._id }, { password: hashedPassword });
        if (updateAuth) {
...
const resetPassword = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const authService = new authentication_service_1.default();
        let auths = yield authService.getAuthentication({ username: user });
        if (!auths || auths.length == 0) {
            auths = yield authService.getAuthentication({ email: user });
            if (!auths || auths.length == 0) {
                res.status(400).json({ status: false, message: "User does not exist" });
                return;
            }
...
const logout = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const authService = new authentication_service_1.default();
        const updateAuth = yield authService.updateAuthentication({ _id: auth.id }, { devices: auth.devices, JWT: "" });
...
const subscribe2Notification = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const updateAuth = yield authService.updateAuthentication({ _id: auth.id }, { devices: auth.devices });
