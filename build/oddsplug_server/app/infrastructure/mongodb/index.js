...
const administrator_repository_1 = require("./repositories/administrator.repository");
const authentication_repository_1 = require("./repositories/authentication.repository");
...
class MongoDB {
    constructor() {
        ...
        this.administrators = new administrator_repository_1.AdministratorRepository();
        this.authentication = new authentication_repository_1.AuthenticationRepository();
