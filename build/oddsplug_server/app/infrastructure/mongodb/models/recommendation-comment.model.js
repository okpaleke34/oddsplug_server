...
const recommendationCommentSchema = new mongoose_1.Schema({
    authId: { type: mongoose_1.default.Types.ObjectId, ref: 'Authentication', required: true },
    recommendationId: { type: mongoose_1.default.Types.ObjectId, required: true },
