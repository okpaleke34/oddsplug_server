    ...
    getArbitrageUsersSubscriptions(minimumAlert) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const aggregate = [
                ...
                // Lookup to join Auth documents with UserSetting documents
                {
                    $lookup: {
                        from: 'usersettings', // Name of the UserSetting collection (make sure it's correct)
                        localField: '_id', // Field from Auth collection
                ...
                // Lookup to join Auth documents with Subscription documents
                {
                    $lookup: {
